  ...
  return (
    <div>
      ...
      <section className="container px-4 mx-auto">
        <div className="mt-6 sm:flex sm:items-center sm:justify-evenly">
          ...
          <div className="relative flex items-center mt-4 md:mt-0">
            <span className="absolute sm:ml-20 md:ml-60">
              <svg
            ...
            <input
              type="text"
              placeholder="Search"
              className="block sm:ml-20 md:ml-60 w-full py-1.5 pr-5 text-gray-700 border-none rounded-lg md:w-80 placeholder-gray-400/70 pl-11 rtl:pr-11 rtl:pl-5"
            />
          </div>
        </div>

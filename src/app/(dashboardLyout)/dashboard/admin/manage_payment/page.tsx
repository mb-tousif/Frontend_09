    ...
    <div>
      ...
      <div className="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
          ...
          <tbody className="divide-y divide-gray-100 border-t border-gray-100">
            {currentPayments?.map((payment: TPayment) => (
              <tr key={payment?.id} className="hover:bg-gray-500">
                <th className="flex gap-3 px-6 py-4 font-normal text-gray-50">
                ...
                <td className="px-6 py-4 text-gray-50">$ {payment?.amount}</td>
                <td className="px-6 py-4">
        ...
        <PaginationSection
          ...
          dataPerPage={currentPayments?.length}
